...
{$IFDEF conditionalexpressions} {$DEFINE DELPHI_6_UP} {$ENDIF}
...
{$IFDEF VER_120} {$DEFINE DELPHI_4_UP} {$ENDIF}
{$IFDEF VER_130} {$DEFINE DELPHI_4_UP} {$ENDIF}
{$IFDEF conditionalexpressions} {$DEFINE DELPHI_4_UP} {$ENDIF}
{$DEFINE DELPHI_4_UP}
...
{$ENDIF UNICODE}
  ...
  THintString = string;       // 128 bytes, last char should be #0
